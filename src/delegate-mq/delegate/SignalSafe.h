...
/// @file
/// @brief Delegate containers (`Signal`, `SignalSafe`) that support RAII connection management.
///
/// @details This header defines `Signal` and `SignalSafe` classes, which extend the standard
